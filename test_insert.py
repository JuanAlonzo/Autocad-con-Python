...
def main():
    ...
    try:
        ...
        ui.show_message(
            f"ERROR CRÍTICO: El bloque '{BLOQUE_NOMBRE}' NO existe en este dibujo.", "error")
        return

    # 3. Obtener punto de inserción (Cerca del origen o donde estés mirando)
    # Usaremos una coordenada fija cercana a tus datos del CSV para que lo veas
    # CSV dice: X=2968.9, Y=1375.7. Usaremos 3000, 1400.
    ...
    try:
        ...
        ui.show_message(
            f"2. Bloque insertado (Escala 1/250 = {scale_inv}). Handle: {blk2.Handle}", "success")
    except Exception as e:
    ...
    ui.show_message(
        "Prueba finalizada. Revisa en AutoCAD cuál se ve bien.", "info")
